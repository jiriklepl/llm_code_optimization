# Role
Your goal is to analyze the given C code with embedded Exo kernel specifications and produce an optimized model description that captures its semantics and optimization opportunities.
...
# Modeling Guidelines
Carefully examine the Exo kernel to understand its buffers, schedules, and computation, then translate those semantics into a model representation that exposes optimization opportunities.
