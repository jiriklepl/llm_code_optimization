...
# This script compares the output of the C and C++/Halide implementations of the Polybench benchmarks
# It assumes that the C++/Halide implementations are built in the build directory and that the C implementations are built in the $POLYBENCH_C_DIR/build directory
